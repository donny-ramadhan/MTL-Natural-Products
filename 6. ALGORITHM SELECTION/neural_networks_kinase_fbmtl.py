...
for outer_train_index, outer_test_index in outer_skf.split(X, data['Target ChEMBL ID']):
    ...
    final_model.fit(X_outer_train, y_outer_train, epochs=best_params["epochs"], batch_size=best_params["batch_size"], verbose=0)
...
data_save_path = '/Users/Ramadhan/NP-MTL/Algorithm_Selection/neural_networks_kinase_fbmtl_prediction.txt'
...
final_results_save_path = '/Users/Ramadhan/NP-MTL/Algorithm_Selection/neural_networks_kinase_fbmtl_statistics.txt'
