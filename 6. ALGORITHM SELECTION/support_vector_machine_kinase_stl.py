...
for (target_parent_id, protein_class_id, target_chembl_id), group in groups:
    ...
    for fold in group_global_folds:
        ...
        final_model = SVR(C=best_params["C"], epsilon=best_params["epsilon"], gamma=best_params["gamma"], kernel='rbf')
...
predictions_save_path = '/Users/Ramadhan/NP-MTL/Algorithm_Selection/support_vector_machine_kinase_stl_prediction.txt'
...
final_results_save_path = '/Users/Ramadhan/NP-MTL/Algorithm_Selection/support_vector_machine_kinase_stl_statistics.txt'
