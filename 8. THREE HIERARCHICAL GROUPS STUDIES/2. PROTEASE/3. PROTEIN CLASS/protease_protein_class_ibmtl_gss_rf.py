...
# Load dataset
file_path = '/Users/Ramadhan/NP-MTL/Filtering_Preprocessing/protease_three_groups_protein_class_final_dataset_gss_for_stl_mtl.txt'
...
# Group by Target Parent ID and Protein Class ID (excluding Target ChEMBL ID)
groups = data.groupby(['Target Parent ID', 'Protein Class ID'])

# Process nested CV for each group separately using the pre-assigned global folds
for (target_parent_id, protein_class_id), group in groups:
    ...
    for fold in group_global_folds:
        ...
        best_params_dict[(target_parent_id, protein_class_id, fold)] = best_params
...
data_save_path = '/Users/Ramadhan/NP-MTL/STL_MTL_Three_Groups_Studies/protease_three_groups_protein_class_rf_ibmtl_gss_prediction.txt'
...
final_results_save_path = '/Users/Ramadhan/NP-MTL/STL_MTL_Three_Groups_Studies/protease_three_groups_protein_class_rf_ibmtl_gss_statistics.txt'
