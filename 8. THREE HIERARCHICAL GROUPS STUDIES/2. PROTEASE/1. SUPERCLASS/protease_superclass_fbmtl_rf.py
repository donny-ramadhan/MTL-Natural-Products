...
for outer_train_index, outer_test_index in outer_skf.split(X, data['Target ChEMBL ID']):
    ...
    X_outer_test, y_outer_test = X[outer_test_index], y[outer_test_index]
...
data_save_path = '/Users/Ramadhan/NP-MTL/STL_MTL_Three_Groups_Studies/protease_three_groups_superclass_rf_fbmtl_prediction.txt'
...
final_results_save_path = '/Users/Ramadhan/NP-MTL/STL_MTL_Three_Groups_Studies/protease_three_groups_superclass_rf_fbmtl_statistics.txt'
